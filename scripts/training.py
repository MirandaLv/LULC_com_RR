...
#
# # Evaluate model
# y_pred_balanced = clf_over_spl.predict(X_test)
#
...
#
# # Evaluate model
# y_pred_res = clf_ud_spl.predict(X_test)
#
...
joblib.dump(rf_model, os.path.join(working_dir, 'models/random_forest_model_small.pkl'))
