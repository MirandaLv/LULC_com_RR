...
model_path = os.path.join(working_dir, 'models/random_forest_model_small.pkl')
...
gdf.to_file(os.path.join(working_dir, 'prediction/mathew_prediction_short.shp'))
